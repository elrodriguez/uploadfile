            ...
            @foreach ($theses as $key => $item)
                <tr>
                    ...
                    <td width="25%">
                        ...
                        <button type="button" class="btn btn-success" onclick="modalEdit('{{ $item->id }}','{{ $item->title }}','{{ $item->state }}')" data-toggle="modal" data-target="#exampleModalEdit">Editar</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="thesis_id" name="thesis_id">
                        </div>
                        <div class="form-group">
